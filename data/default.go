	...
	Tasks: []Task{
			...
			Ingredients: []Ingredient{
				{
					ID:       "ingredient-2",
					Name:     "Pizza Sauce",
					Quantity: Fraction{Whole: 0, Numerator: 1, Denominator: 2},
					Unit:     Cups,
				},
			},
			...
			Ingredients: []Ingredient{
				{
					...
					Quantity: Fraction{Whole: 1, Numerator: 0, Denominator: 0},
					Unit:     None,
				},
			},
			Kitchenware: []Kitchenware{
		...
		},
		{
			...
			Dependencies: []Dependency{
				...
				{
					ID:           "6",
					DependencyID: "task-4.2",
					Title:        "Grate Cheese",
				},
				{
					ID:           "7",
					DependencyID: "task-4.3",
					Title:        "Slice Sausage",
				},
			},
			Ingredients: []Ingredient{
				{
					...
					Quantity: Fraction{Whole: 0, Numerator: 2, Denominator: 3},
					Unit:     Cups,
				},
				{
					ID:       "ingredient-4",
					Name:     "Sausage",
					Quantity: Fraction{Whole: 2, Numerator: 0, Denominator: 0},
					Unit:     Ounces,
				},
				{
					ID:       "ingredient-5",
